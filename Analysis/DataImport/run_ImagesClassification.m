...
default_opts = struct('BinningSpatial', 1, 'BinningTemp', 1, 'b_IgnoreStim', false, 'StimChannel','Internal-main', 'StimPolarity','Positive','LowPassFilter_AnalogIN',false);
opts_values = struct('BinningSpatial', 2.^[0:5], 'BinningTemp',2.^[0:5],'b_IgnoreStim',[false, true], 'StimChannel', {{'Internal-main', 'Internal-Aux','AI1', 'AI2','AI3','AI4','AI5','AI6','AI7','AI8','StimDig'}'},'StimPolarity',{{'Positive','Negative'}}, 'LowPassFilter_AnalogIN',[false,true]);%#ok  % This is here only as a reference for PIPELINEMANAGER.m.
...
ImagesClassification(RawFolder, SaveFolder, opts.BinningSpatial, opts.BinningTemp,...
    opts.b_IgnoreStim, 0, opts.StimChannel, opts.StimPolarity,opts.LowPassFilter_AnalogIN);
