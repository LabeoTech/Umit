...
%
%   outFiles = run_HemoCompute(SaveFolder, data)
%   [HbOFile, HbRFile] = run_HemoCompute(SaveFolder, data)
%   outFiles = run_HemoCompute(SaveFolder, data, 'FilterSet', 'none', ...)
...
fprintf('Finished HemoCompute.\n');
    ...
    function info = localPipelineInfo()
        ...
        info = PipelineManager.addOutput(info, ...
            ...
            'ImageTimeSeries', ...
            'data', ...
            'Oxygenated hemoglobin backing filename.', ...
            default_Output{1}, ...
            1, ...
            'isData', true);
        ...
        info = PipelineManager.addOutput(info, ...
            ...
            'ImageTimeSeries', ...
            'data', ...
            'Deoxygenated hemoglobin backing filename.', ...
            default_Output{2}, ...
            2, ...
            'isData', true);
