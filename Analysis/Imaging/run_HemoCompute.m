...
opts_values = struct('FilterSet',{genFieldsFromFile('FilterSets.mat')},'b_normalize',[true,false],'Red',[false, true], 'Green',[false, true],'Amber',[false, true],'HbT_concentration_uM',[eps,100],'StO2perc',[eps Inf]);%#ok  % This is here only as a reference for PIPELINEMANAGER.m.
