...
opts_values = struct('crop_start_sec', [0 Inf], 'crop_end_sec', [0 Inf]);%#ok<NASGU>
...
% with the trimmed movies. If it is absent, event handling is skipped.
...
if hasEventsFile && numel(unique(recordingDurations_s)) > 1
