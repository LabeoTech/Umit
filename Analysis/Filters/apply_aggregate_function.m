...
%   - If a .umt or .mat file is provided, RAM-safe mode is not available
...
[entryNames, entryData, entryDims, sourceLabels, sourceEventInfo] = ...
...
% =========================================================================
    function info = localPipelineInfo()
        ...
        info = PipelineManager.addInput( ...
            info, ...
            'data', ...
            {'ImageTimeSeries','AnalysisData','UnknownDataType'}, ...
...
% =========================================================================
function [entryNames, entryData, entryDims, labels, eventInfo] = iExtractValidUMTData(umt)
