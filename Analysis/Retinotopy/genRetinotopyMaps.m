...
opts_values = struct( ... %#ok<NASGU> This is here only as a reference for PIPELINEMANAGER.m.
    'b_useAverageMovie', [true,false], ...
    'Direction', {{'All','Azimuth_only','Elevation_only'}}, ...
    'ViewingDist_cm', [0,Inf], ...
    'ScreenXsize_cm', [0,Inf], ...
    'ScreenYsize_cm', [0,Inf]);
