...
addpath(genpath('G:\RealData4Testing_UMIT'));
maindir = 'G:\RealData4Testing_UMIT\RawData';
savedir = 'G:\RealData4Testing_UMIT\SaveFolder';
protocol = Protocol('RealDataFromSolenn', maindir, savedir, @RealData4Testing_UMIT_protoFunc, []);
...
protocol.FilterStruct.Acquisition.Expression = 'Ret_'; % Leave empty to select all
...
pipe.addTask('FluorescenceImaging', 'get_timestampsFromSingleChannel');
% 
