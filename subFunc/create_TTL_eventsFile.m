function create_TTL_eventsFile(saveFolder, TTLsignal, sample_rate, varargin)
% CREATE_TTL_EVENTSFILE creates a .MAT file containing the channel, state
% and time stamps of a TTL signal(TTLSIGNAL) passing a given threshold(THRESHOLD).
% Inputs:
